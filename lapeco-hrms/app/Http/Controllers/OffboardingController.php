...
class OffboardingController extends Controller
{
    ...
    /**
     * Get comprehensive offboarding data including both resignations and terminations
     */
    public function index(Request $request): JsonResponse
    {
        ...
        // Get approved resignations (voluntary)
    ...
    /**
     * Transform resignation data for consistent API response
     */
    ...
    /**
     * Transform termination data for consistent API response
     */
    private function transformTermination($termination): array
    {
        ...
        return [
            ...
            'type_detail' => $termination->type, // voluntary/involuntary
